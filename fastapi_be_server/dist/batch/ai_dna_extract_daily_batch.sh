...
# - OpenRouter로 작품 본문(1~10화)을 분석하여 7축 DNA 추출
# - 미분석/10화 미만 작품 자동 갱신
...
AI_DNA_PROVIDER="${AI_DNA_PROVIDER:-openrouter}"
